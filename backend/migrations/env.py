...
# Add your project root to the path so `app` is importable
...
from app.models.oncall import OnCallSchedule, Deployment
...
# Otherwise, alembic.ini's sqlalchemy.url is used as-is.
